...
main = tkinter.Tk()
main.title("A Real-Time Secure State-Level Elections using Iris Biometrics Based Voter Identification System") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='A Real-Time Secure State-Level Elections using Iris Biometrics Based Voter Identification System')
